    ...
    <Section id="services">
      ...
      <Container>
        <SectionHeading
          ...
          lead="Most teams juggle an agency, a freelancer and a contractor who never speak to each other. We cover strategy, design, engineering, AI, data and care — so nothing falls between the gaps."
        />
